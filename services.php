...
<div class="sec">
	...
	<div class="row service-entry">
		<div class="col-md-4"><?php print '<img class="img-full" src="'.$base_url.'assets/images/home_feat01.jpg">';?></div>
		<div class="col-md-8">
	...
	<div class="row service-entry">
		<div class="col-md-4"><?php print '<img class="img-full" src="'.$base_url.'assets/images/home_feat02.jpg">';?></div>
		<div class="col-md-8">
	...
	<div class="row service-entry">
		<div class="col-md-4"><?php print '<img class="img-full" src="'.$base_url.'assets/images/home_feat03.jpg">';?></div>
		<div class="col-md-8">
